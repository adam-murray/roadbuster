...
def _get_model_fields(instance, model, field_exclusion_list=[]):
    """
    Returns a list of field names and contents for a given model instance
    - useful when making new versioned content types
    :param instance: A model instance
    :param model: The model
    :param field_exclusion_list: Fields to ignore
    :return: Dictionary {field name: field contents}
    """
